...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFF9A00A),
      surfaceTint: Color(0xFFF9A00A),
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFFfff05a),
      onPrimaryContainer: Color(0xFFd17800),
      secondary: Color(0xFFF8BB55),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFffffa5),
      onSecondaryContainer: Color(0xFFd0932d),
      tertiary: Color(0xFFFC9403),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFFffe453),
      onTertiaryContainer: Color(0xFFd46c00),
      ...
      inversePrimary: Color(0xFFe58c00),
      primaryFixed: Color(0xFFfff05a),
      onPrimaryFixed: Color(0xFFbd6400),
      primaryFixedDim: Color(0xFFffdc46),
      onPrimaryFixedVariant: Color(0xFFe58c00),
      secondaryFixed: Color(0xFFffffa5),
      onSecondaryFixed: Color(0xFFbc7f19),
      secondaryFixedDim: Color(0xFFfff791),
      onSecondaryFixedVariant: Color(0xFFe4a741),
      tertiaryFixed: Color(0xFFffe453),
      onTertiaryFixed: Color(0xFFc05800),
      tertiaryFixedDim: Color(0xFFffd03f),
      onTertiaryFixedVariant: Color(0xFFe88000),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFe58c00),
      surfaceTint: Color(0xFFe58c00),
      onPrimary: Color(0xFFa95000),
      primaryContainer: Color(0xFFbd6400),
      onPrimaryContainer: Color(0xFFfff05a),
      secondary: Color(0xFFe4a741),
      onSecondary: Color(0xFFa86b05),
      secondaryContainer: Color(0xFFbc7f19),
      onSecondaryContainer: Color(0xFFffffa5),
      tertiary: Color(0xFFe88000),
      onTertiary: Color(0xFFac4400),
      tertiaryContainer: Color(0xFFc05800),
      onTertiaryContainer: Color(0xFFffe453),
      ...
      inversePrimary: Color(0xFFF9A00A),
      primaryFixed: Color(0xFFfff05a),
      onPrimaryFixed: Color(0xFFbd6400),
      primaryFixedDim: Color(0xFFffdc46),
      onPrimaryFixedVariant: Color(0xFFe58c00),
